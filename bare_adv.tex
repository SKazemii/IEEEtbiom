...
%% (requires IEEEtran.cls version 1.8b or later) with an IEEE Biometrics Council
...
% For Biometrics Council journals, IEEEtran defaults to the use of 
% Palatino/Palladio as is done in IEEE Biometrics Council journals.
...
\ifCLASSOPTIONcompsoc
  % The IEEE Biometrics Council needs nocompress option
...
pdftitle={Bare Demo of IEEEtran.cls for Biometrics Council Journals},%<!CHANGE!
pdfsubject={Typesetting},%<!CHANGE!
pdfauthor={Michael D. Shell},%<!CHANGE!
pdfkeywords={Biometrics Council, IEEEtran, journal, LaTeX, paper,
             template}}%<^!CHANGE!
%\ifCLASSINFOpdf
...
\title{Bare Advanced Demo of IEEEtran.cls for\\ IEEE Biometrics Council Journals}
%
%
...
\thanks{Manuscript received April 19, 2015; revised August 26, 2015.}}
...
{Shell \MakeLowercase{\textit{et al.}}: Bare Advanced Demo of IEEEtran.cls for IEEE Biometrics Council Journals}
...
% column for its text to clear the IEEEpubid mark (Biometrics Council journal
...
\begin{IEEEkeywords}
Biometrics Council, IEEE, IEEEtran, journal, \LaTeX, paper, template.
\end{IEEEkeywords}}
...
for IEEE Biometrics Council journal papers produced under \LaTeX\ using
