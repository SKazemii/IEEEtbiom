...
% Some/most Biometrics Council conferences require the compsoc mode option,
...
\title{Bare Demo of IEEEtran.cls for\\ IEEE Biometrics Council Conferences}
...
for IEEE Biometrics Council conference papers produced under \LaTeX\ using
